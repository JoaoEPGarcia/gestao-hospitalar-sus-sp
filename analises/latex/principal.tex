...
% Parte atual: Análise Exploratória do painel de hospitais SUS/SP.
...
\graphicspath{{figuras_analise_exploratoria/}}
...
\begin{titlepage}
  ...
  \vspace{1.2cm}
  {\Large Análise Exploratória do Painel de Hospitais SUS/SP,
   2015 a 2025\par}
  \vspace{3.5cm}
  {\large
