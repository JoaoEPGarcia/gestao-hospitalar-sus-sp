...
em 2,18 pontos na janela de três ou mais anos; a leitura causal desses
...
queda de 12,1\% três ou mais anos depois, resultado que deve ser lido
com cautela: o teste de tendências anteriores do custo é rejeitado e
49\% dos conversores placebo da Seção~\ref{sec:inferenciafinal}
produzem efeito igual ou maior. A \textbf{ocupação de
...
para a fração de alta complexidade (p igual a 0,344), é rejeitado
também para o custo (p igual a 0,031), ainda que com folga menor, e é
rejeitado para a mortalidade e a ocupação} (p abaixo de 0,001). A rejeição na mortalidade tem nome e
