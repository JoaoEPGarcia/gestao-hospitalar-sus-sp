...
assistencial.} Toda leitura de mortalidade nesta fase usa a
...
reserva sugerida, logo depois, reúne os pares casados de contraste com
...
\noindent\textbf{7573162, Hospital Regional de Jundiaí} (Jundiaí, interior; Médio Porte, faixa Barcelona 3, complexidade estrutural 246,0). Desviante positivo da categoria OSS (quartil superior persistente de eficiência técnica em DEA e SFA): medianas de 0,905 no DEA e 0,999 na SFA entre 2015 e 2025, no suporte comum de faixa 3 e Médio Porte. Marcador financeiro$\times$físico: 4\textordmasculine{} no rank DEA com insumo financeiro contra 18\textordmasculine{} só com leitos (diferença de 14 posições).\par\medskip
...
\begin{figure}[H]
\centering
\includegraphics[width=.95\textwidth]{fig_sel_c_2080354.png}
\caption{Hospital Santo Antônio (CNES 2080354), desviante negativo da
rede Filantrópico.}
\label{fig:sel2080354}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=.95\textwidth]{fig_sel_d_2065665.png}
...
Ranks calculados entre os 280 CNES da rede elegível (289 menos Privado,
conversores e o CNES de denominador frágil).

\noindent\textbf{2077590, IBCC} (São Paulo, capital; Grande Porte, faixa Barcelona 3, complexidade estrutural 176,0). Divergência entre métodos: posição 57 no DEA contra 273 na SFA entre 280 CNES (DEA favorável, SFA desfavorável).\par\medskip
\noindent\textbf{2089785, Hospital do Rim e Hipertensão} (São Paulo, capital; Grande Porte, faixa Barcelona 3, complexidade estrutural 227,0). Divergência entre métodos: posição 39 no DEA contra 251 na SFA entre 280 CNES (DEA favorável, SFA desfavorável).\par\medskip
\noindent\textbf{2083086, Hospital Amaral Carvalho} (Jaú, interior; Grande Porte, faixa Barcelona 4, complexidade estrutural 415,0). Divergência entre métodos: posição 28 no DEA contra 232 na SFA entre 280 CNES (DEA favorável, SFA desfavorável).\par\medskip
\noindent\textbf{2790734, Instituto Lauro de Souza Lima} (Bauru, interior; Médio Porte, faixa Barcelona 2, complexidade estrutural 27,0). Divergência entre métodos: posição 67 no DEA contra 262 na SFA entre 280 CNES (DEA favorável, SFA desfavorável).\par\medskip
\noindent\textbf{9601, Hospital Pio XII} (São José dos Campos, interior; Médio Porte, faixa Barcelona 3, complexidade estrutural 141,0). Divergência entre métodos: posição 73 no DEA contra 253 na SFA entre 280 CNES (DEA favorável, SFA desfavorável).\par\medskip
...
plenas; a reserva sugerida (blocos d e e) acrescenta até dez. O teto
