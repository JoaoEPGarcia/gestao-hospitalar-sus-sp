...
SEÇÃO DESATUALIZADA --- TEXTO AINDA DA SELEÇÃO DO PAINEL DE 314\\[2pt]
\normalfont\normalsize A seleção foi \textbf{reexecutada em 18/07/2026}
sobre o painel de 289 (24 hospitais; \texttt{tab\_selecao\_entrevistas.csv}
e \texttt{roteiro\_entrevistas.tex} atualizados, com o marcador
financeiro$\times$físico). Os blocos abaixo ainda descrevem a seleção
antiga e citam hospitais excluídos pela ETAPA F, entre eles Darcy
Vargas (2071371), Boldrini (2081482) e o Centro Hospitalar do Sistema
Penitenciário (3001466). Reescrita desta seção pendente; até lá, usar
o roteiro regenerado, não este texto.}}
\end{center}
\bigskip
