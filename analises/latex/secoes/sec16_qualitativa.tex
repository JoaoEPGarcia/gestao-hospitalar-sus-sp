...
cautela e investigação de mecanismo. O quarto é que o custo real por
saída não difere entre categorias: a diferença de gestão, se existe, não
aparece no custo. Toda leitura de mortalidade nesta fase usa a
...
em TMP, mortalidade e custo, ou acima em produção, o hospital supera a
...
mediana da categoria em TMP e custo, ou abaixo em produção, marcando a
