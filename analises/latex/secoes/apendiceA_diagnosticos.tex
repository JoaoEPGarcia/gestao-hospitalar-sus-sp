...
marginais de custo e TMP da Seção~\ref{sec:distribuicoes}.
...
versão sem esses hospitais está na Figura~\ref{fig:qqtmpsemlp}, no
corpo do documento.}
...
vem de misturar 314 hospitais heterogêneos, não do molde.
