...
verificações. A ordem interna das outras três categorias é mais
frágil — o DEA mostra Direta e Município praticamente empatados
(diferença de 0,002, adiante) e a SFA, também adiante, mostra outro
empate de ponto entre Direta e Filantrópico (0,788 contra 0,784) —
então a ordenação completa OSS, Município, Direta, Filantrópico não
deve ser lida como hierarquia firme abaixo da OSS. Ela
...
de \textbf{cerca de 25\% menos distância à fronteira que a Direta}
(exp(-0,293) menos 1), estável retirando o biênio pandêmico, os cinco
conversores ou restringindo ao suporte comum. Ao contrário da mortalidade,
\textbf{a eficiência
...
a ordem das redes na ponta de cima, com duas honestidades a registrar:
...
separação perfeita da Seção~\ref{sec:estrategia}), e por isso o NÍVEL
da eficiência das OSS na SFA não é citável — vale a ordem, não o
número; e, na outra ponta, Direta (0,788) e Filantrópico (0,784)
...
em nenhum dos dois métodos para confirmar ou afastar sobreposição). O
resultado síntese
...
A concordância não cresce de forma gradual: fica achatada entre 0,50 e
