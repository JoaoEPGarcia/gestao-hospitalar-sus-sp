...
produção, maior ocupação e maior uso de UTI (18,2\% acima da Direta,
p~igual a 0,005, na Seção~\ref{sec:inferenciafinal}), um contraste
transversal firme entre as redes, visível na produção física por leito
que não usa dinheiro nenhum (54 saídas por leito nas OSS contra 35 na
...
(Seção~\ref{sec:fase2}), cerca de 40\% menos distância à fronteira que
...
Visível nos dados brutos dos conversores, ela \textbf{não sobrevive ao
controle sintético}: em Sorocaba o hospital real termina \emph{acima}
do seu gêmeo, com efeito nulo, e no Pérola Byington a queda existe mas
fica dentro do que sorteios de placebo produzem (p~igual a 0,33). A
...
mostrou diferença em método nenhum} foi o custo real por saída, igual
...
de permutação. Sobre o grupo \textbf{Privado} (n~igual a 3), a regra do
...
gestão por OSS reduz a mortalidade}: a evidência aponta o contrário
depois do confronto com o controle sintético, e citar a queda bruta
seria trair o próprio achado central do trabalho. Segundo, toda a
