...
% PENDENTE (reconciliação painel 289, 18/07/2026): "309" abaixo deveria
% virar 284 (289-5). NÃO editar isolado — o resto deste parágrafo
% (p-valores da permutação) só fica correto depois do Bloco 3
% (inferencia_robusta.py rodar no painel de 289). Ver
% auditoria-fase2-jul2026.md, bloqueante B2.
...
que sorteios de placebo produzem (p igual a 0,33). No faturamento real, a
lacuna do Pérola é de R\$ 354 a menos por saída (p igual a 0,28).
