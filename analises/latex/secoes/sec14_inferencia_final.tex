...
(0,25 contra 0,15 em log pontos) e as janelas longas voltam a
coincidir. Nenhuma conclusão muda; a magnitude intermediária do tempo
...
resíduos salta de 0,814 para \textbf{0,944} (Figura~\ref{fig:qqgama}),
...
\comoler{compare com o último painel da Seção~\ref{sec:robustez}: os
pontos que antes despencavam da linha tracejada na ponta esquerda
agora a acompanham em quase todo o trajeto.}
...
UTI, diferenças firmes); o tempo de permanência menor é a evidência
causal mais consistente, presente em todos os métodos, ainda que com
cinco conversores ela permaneça sugestiva e não definitiva; o custo
...
significância no Pérola Byington. Novos anos de dados, especialmente
